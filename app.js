...
const scenarios = {
  ...
  follow: { message:'Thanks for the quote.<br>Could you confirm the delivery date?', version:'v2', quantity:'2,000', price:'2.63', total:'5,260', zh:{state:'待确认交期',rule:'客户询问交期，需核实是否影响现有报价条件',next:'核实工厂可交付日期，再起草跟进回复。',announcement:'跟进示例：客户询问交期，需要业务员核实后回复。'}, en:{state:'Confirm delivery',rule:'Check whether the requested delivery date affects the current quote.',next:'Check the available delivery date, then draft a reply.',announcement:'Follow-up example: the customer asks about delivery. Confirm the date before replying.'} },
